export const site = {
  ...
  legalForm: "Société à Mission",
  whatsapp: "https://wa.me/2340000000000",
  offices: [
    {
      country: "France (Registered Office)",
      entity: "Tripp Energy and Mobility (Société à Mission)",
      address: "2 Rue Robert d'Arbrissel, 35065 Rennes, France",
      email: "contact@trippenergy.com",
    },
    {
      country: "Nigeria (Operational Office)",
  ...
  contactEmails: [
    { label: "DFI and Investors", email: "dfi@trippenergy.com" },
